...
function() {
    ...
    AreaPanel.prototype = {
        createPanelArea: function() {
            let t = this,
            e = (this.panelArea = document.createElement("div"), this.panelArea.className = "fm-editor-panel-area-container", this.panelAreaBox = document.createElement("div"), this.panelAreaBox.className = "fm-editor-panel-area-box", this.panelArea.appendChild(this.panelAreaBox), this.element.appendChild(this.panelArea), this.panelButtonArea = document.createElement("div"), this.panelButtonArea.className = "fm-editor-panel-area-button-container", this.panelButtonArea.innerHTML = "<div class='fm-editor-panel-area-moveup-button'><div class='arrow-up'></div></div><div class='fm-editor-panel-area-movedown-button'><div class='arrow-down'></div></div><div class='fm-editor-panel-area-popup-button'><div class='left-down-arrow'></div></div>", this.element.appendChild(this.panelButtonArea), this.panelButtonArea.getElementsByClassName("fm-editor-panel-area-popup-button")[0]),
            i = (e.addEventListener("click", function(e) {
                t.toggleSections(e)
            }), this.panelButtonArea.getElementsByClassName("fm-editor-panel-area-movedown-button")[0]),
            m = (i.addEventListener("click", function(e) {
                t.scrollDownAreaBox()
            }), this.panelButtonArea.getElementsByClassName("fm-editor-panel-area-moveup-button")[0]);
        ...
        createSections: function(t) {
            ...
            i = (e.className = "fm-editor-panel-area-section-container", document.createElement("div")),
            m = (i.className = "fm-editor-panel-area-section-box", i.style.width = this.sectionWidth + "px", e.appendChild(i), document.createElement("div")),
            a = (m.className = "fm-editor-panel-area-section-box-container", i.appendChild(m), document.createElement("div"));
        ...
        toggleSections: function(e) {
            return null != this.sectionsMountPoint && (this.active ? this.hideSections(e) : this.showSections(e)),
            e.stopPropagation(),
            !1
        },
        showSections: function(e) {
            null != this.toolbar.activePanel && this.toolbar.activePanel.hideSections(e),
        ...
        appendSection: function(e, t, i, m) {
            ...
            0 < e.buttons.length && (t.appendChild(e.element), this.sections.push(e), i.addListItem(e, m))
        },
        ...
        scrollDownAreaBox: function() {
            ...
            t = this.getMarginTop();
            this.panelAreaBox.style.marginTop = Math.min(0, Math.max(56 - e + e % 28, t - 56)) + "px"
        },
...
function() {
    ...
    ButtonPanel.prototype = {
        createPanelButton: function() {
            ...
            let e = document.createElement("div"),
            t = (e.className = "fm-editor-panel-button-icon math math-" + this.id + "-btn", document.createElement("div")),
            i = (t.className = "fm-editor-panel-button-label", t.innerHTML = this.name, this.buttonElement.appendChild(e), this.buttonElement.appendChild(t), this.element.appendChild(this.buttonElement), this);
        ...
        showSections: function(e) {
            if (null != this.toolbar.activePanel && this.toolbar.activePanel.hideSections(e), this.active = !0, DomUtils.addClass(this.element, "active"), this.buttonElement.getBoundingClientRect().left + this.sectionWidth > document.body.clientWidth) {
                let e = -this.sectionWidth + this.buttonElement.clientWidth;
                e < -this.buttonElement.getBoundingClientRect().left && (e = 20 - this.buttonElement.getBoundingClientRect().left),
        ...
        appendSection: function(e, t) {
            e = new ButtonSection(e, this);
            0 < e.buttons.length && (t.appendChild(e.element), this.sections.push(e))
        },
        redraw: function() {
            this.sections = [],
            this.sectionsMountPoint.parentNode.removeChild(this.sectionsMountPoint),
    ...
    ButtonSection.prototype = {
        createButtons: function(t) {
            ...
            for (let e = 0; e < t.length; e++) {
                var o = t[e],
                l = i.get(o);
                l && l[m] && (l = new Button(o, this), a.appendChild(l.element), this.buttons.push(l))
            }
...
function() {
    ...
    DropdownList.prototype = {
        ...
        toggleList: function(e) {
            return this.active ? this.hideList(e) : this.showList(e),
            e.stopPropagation(),
            !1
        },
        hideList: function(e) {
    ...
    Editor.prototype = {
        init: function() {
            ...
            document.addEventListener("click", function(e) {
                null != t.toolbar.activePanel && t.toolbar.activePanel.hideSections(e),
                t.toolbar.mlangPanel.hideList(),
                (-1 == e.target.id.indexOf("btn") || -1 == e.target.id.indexOf("table") && -1 == e.target.id.indexOf("matrix")) && t.hideMatrixPopup()
            }),
        ...
        addEquation: function(e) {
            ...
            let i = t[this.mlang];
            if (t.matrix) this.currentMatrixEquation = i,
            this.showMatrixPopup(e.clientX, e.clientY);
            else {
                t = /\{\{\$\}\}/g,
                e = i.match(t);
                if (e && 0 < e.length) if (1 == e) i = i.replace(t, "x");
                else {
                    let e = 1;
                ...
                i = i.trim(),
                this.insertEquationToTextarea(i)
            }
        },
        ...
        insertMatrixToTextarea: function() {
            var t = parseInt(document.getElementById("fm-editor-matrix-rows").value),
            i = parseInt(document.getElementById("fm-editor-matrix-columns").value);
            let m = this.currentMatrixEquation;
            if (this.hideMatrixPopup(), null !== m && 0 < t && 0 < i) {
                let e = "";
                e = "latex" == this.mlang ? this.createMatrixCodeLatex(t, i) : this.createMatrixCodeMml(t, i),
        ...
        createMatrixCodeLatex: function(e, i) {
            let m = "";
            for (let t = 0; t < e; t++) {
                for (let e = 0; e < i; e++) m += " x_" + (e + 1 + t * i),
                e < i - 1 ? m += " &" : m += " ";
                t < e - 1 && (m += "\\\\")
            }
            return m
        ...
        createMatrixCodeMml: function(e, i) {
            ...
            for (let t = 0; t < e; t++) {
                m += "<mtr>";
                for (let e = 0; e < i; e++) m += "<mtd><msub><mi>x</mi><mi>" + (e + 1 + t * i) + "</mi></msub></mtd>";
                m += "</mtr>"
            }
            return m
        },
        renderEquationToResultarea: function(e) {
            "" !== (e = e || "").trim() ? (e = "latex" == this.mlang ? "$$" + e.trim() + "$$" : '<math xmlns="http://www.w3.org/1998/Math/MathML" mode="display">' + e.trim() + "</math>", this.toolbar.mlangPanel.disable(), this.resultarea.innerHTML = e, MathJax.Hub.Queue(["Typeset", MathJax.Hub, this.resultarea])) : (this.toolbar.mlangPanel.enable(), this.resultarea.innerHTML = "")
        },
        createTextArea: function() {
            let e = document.createElement("div"),
            t = (e.className = "fm-editor-content-area", this.textarea = document.createElement("textarea"), this.textarea.className = "fm-editor-content", e.appendChild(this.textarea), this.element.appendChild(e), this);
        ...
        createResultArea: function() {
            let e = document.createElement("div"),
            t = (e.className = "fm-editor-result-area", document.createElement("div"));
        ...
        getEquationPng: function(r) {
            ...
            if (e) {
                ...
                l.onload = function() {
                    ...
                    t = (e.width = l.width, e.height = l.height, e.getContext("2d"));
                    t.drawImage(l, 0, 0);
...
function() {
    ...
    MlangPanel.prototype = {
        createPanelButton: function() {
            let e = document.createElement("div"),
            t = (e.className = "fm-editor-panel-button", document.createElement("div")),
            i = (t.className = "fm-editor-panel-button-icon math math-" + this.id + "-btn", this.labelButtonText = document.createElement("div"), this.labelButtonText.className = "fm-editor-panel-button-label", this.labelButtonText.innerHTML = this.mlangs[this.currentMlang], e.appendChild(t), e.appendChild(this.labelButtonText), this.element.appendChild(e), this);
            e.addEventListener("click", function(e) {
                return i.enabled && i.toggleList(e),
                null != i.toolbar.activePanel && i.toolbar.activePanel.hideSections(e),
                e.stopPropagation(),
                !1
            })
        },
        ...
        changeActiveItem: function(e) {
            null != this.activeItem && (this.activeItem.unsetActive(), this.toolbar.editor.mlang = e.id, this.toolbar.redraw()),
            this.activeItem = e,
            this.labelButtonText.innerHTML = e.name
        },
        disable: function() {
...
function() {
    ...
    Toolbar.prototype = {
        createPanels: function(t) {
            ...
            let i = document.createElement("div");
            i.className = "fm-editor-panel-container",
            this.createMlangPanel(i);
            for (let e = 0; e < t.length; e++) {
                var m = t[e];
...
function() {
    ...
    HashArray.prototype = {
        ...
        remove: function(e) {
            return !! this.obj.hasOwnProperty(e = "$" + e) && (delete this.obj[e], !0)
        },
        exists: function(e) {
...
function() {
    ...
    window.DomUtils = {
        ...
        removeClass: function(e, t) {
            e.classList ? e.classList.remove(t) : this.hasClass(e, t) && (t = new RegExp("(\\s|^)" + t + "(\\s|$)"), e.className = e.className.replace(t, " "))
        },
        ...
        replaceSVGUseWithGraphElements: function(e) {
            for (var t = e.getElementsByTagName("use"), i = [], m = [], a = 0; a < t.length; a++) {
                for (var o, l = t[a], r = l.getAttribute("href").replace("#", ""), n = document.getElementById(r).cloneNode(!0), s = (n.id += "-c-" + (new Date).getTime(), {}), d = 0; d < l.attributes.length; d++) {
                    var c = l.attributes[d];
                    "href" !== c.nodeName && "x" !== c.nodeName && "y" !== c.nodeName ? n.setAttribute(c.nodeName, c.nodeValue) : "x" != c.nodeName && "y" != c.nodeName || (s[c.nodeName] = c.nodeValue)
                }
                s.x && (r = (s.x || 0) + ", " + (s.y || 0), "" !== (o = n.getAttribute("transform") || "") && (o += " "), o += "translate(" + r + ")", n.setAttribute("transform", o)),
                i.push(n),
                m.push(l)
            }
            for (a = 0; a < i.length; a++) {
                var u = m[a];
                m[a] = a,
                u.parentNode.replaceChild(i[a], u)
            }
        }
    },
    HTMLTextAreaElement.prototype.insertAtCaret = function(e) {
        var t, i;
        e = e || "",
        document.selection ? (this.focus(), document.selection.createRange().text = e) : this.selectionStart || 0 === this.selectionStart ? (t = this.selectionStart, i = this.selectionEnd, this.value = this.value.substring(0, t) + e + this.value.substring(i, this.value.length), this.selectionStart = t + e.length, this.selectionEnd = t + e.length) : this.value += e
    },
    HTMLTextAreaElement.prototype.getCaret = function() {
        ...
        if (document.selection) {
            ...
            i = t.duplicate();
            return t.moveToBookmark(e.getBookmark()),
    ...
    window.Url = {
        get get() {
            var m = {};
            return 0 !== window.location.search.length && window.location.search.replace(/[?&]+([^=&]+)=([^&]*)/gi, function(e, t, i) {
                t = decodeURIComponent(t),
                void 0 === m[t] ? m[t] = decodeURIComponent(i) : m[t] = [].concat(m[t], decodeURIComponent(i))
            }),
            m
        }
    }
