...
public class exm_mat_pass_unit implements SysEntity{ 
	public Long id;
	...
	public exm_mat_pass_unit() {
		//System.out.println("Entity");
	}
 public exm_mat_pass_unit(exm_mat_pass_unit copy) {
	 num_no= copy.num_no;
	 id= copy.id;
	 hd_no= copy.hd_no;
...
public boolean equals(Object obj) {
        ...
        exm_mat_pass_unit other = (exm_mat_pass_unit) obj;
        return
        		Objects.equals(
        				id,other.id)&&
