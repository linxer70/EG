...
public class exm_mat_make_hd implements SysEntity{ 
	public Long id;
	public Long list_id;
	public Long hd_id;
	...
	public exm_mat_make_hd() {
		//System.out.println("Entity");
	}
 public exm_mat_make_hd(exm_mat_make_hd copy) {
	 num_no= copy.num_no;
	 id= copy.id;
...
public boolean equals(Object obj) {
        ...
        exm_mat_make_hd other = (exm_mat_make_hd) obj;
        return
        		Objects.equals(
        				id,other.id)&&
        		Objects.equals(list_id,other.list_id)&&
...
public Long get_list_id() { return list_id;}
...
public void set_list_id(Long unit_id){ this.list_id=unit_id;}
public void set_hd_id(Long unit_id){ this.hd_id=unit_id;}
...
public void set_view_yn(String view_yn){ this.type_nm=view_yn;}
...
@Override
	public Object getValue(String col) {
    	...
    	if(col.equals(
"id")){ obj = id; }
      	 else if(col.equals("list_id")){ obj = list_id; }
...
if(col.equals( 
"id")){id= (Long)obj; }
else if (col.equals("list_id")){list_id= (Long)obj; }
