...
public class exm_mat_make_list implements SysEntity{ 
	public Long id;
	...
	public exm_mat_make_list() {
		//System.out.println("Entity");
	}
 public exm_mat_make_list(exm_mat_make_list copy) {
	 num_no= copy.num_no;
	 id= copy.id;
	 hd_no= copy.hd_no;
...
public boolean equals(Object obj) {
        ...
        exm_mat_make_list other = (exm_mat_make_list) obj;
        return
        		Objects.equals(
        				id,other.id)&&
...
public Long get_tot_num() { return tot_num;}
public Integer get_num_no() { return num_no;}
public Long get_time_limit() { return time_limit;}
...
public void set_tot_num(Long tot_num){ this.tot_num=tot_num;}
public void set_num_no(Integer num_no){ this.num_no=num_no;}
public void set_time_limit(Long time_limit){ this.time_limit=time_limit;}
...
public void set_unit_id(Long unit_cd){ this.unit_id=unit_cd;}
public void set_type_id(Long type_cd){ this.type_id=type_cd;}
public void set_class_id(Long class_cd){ this.class_id=class_cd;}
public void set_subject_id(Long subject_cd){ this.subject_id=subject_cd;}
