...
public class exm_mat_pass_hd implements SysEntity{ 
	public Long id;
	...
	public exm_mat_pass_hd() {
		//System.out.println("Entity");
	}
 public exm_mat_pass_hd(exm_mat_pass_hd copy) {
	 num_no= copy.num_no;
	 id= copy.id;
	 hd_no= copy.hd_no;
...
public boolean equals(Object obj) {
        ...
        exm_mat_pass_hd other = (exm_mat_pass_hd) obj;
        return
        		Objects.equals(
        				id,other.id)&&
