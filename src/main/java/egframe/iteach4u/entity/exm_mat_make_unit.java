...
public class exm_mat_make_unit implements SysEntity{ 
	public Long id;
	...
	public exm_mat_make_unit() {
		//System.out.println("Entity");
	}
 public exm_mat_make_unit(exm_mat_make_unit copy) {
	 num_no= copy.num_no;
	 id= copy.id;
	 hd_no= copy.hd_no;
...
public boolean equals(Object obj) {
        ...
        exm_mat_make_unit other = (exm_mat_make_unit) obj;
        return
        		Objects.equals(
        				id,other.id)&&
