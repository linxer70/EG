...
@Route(value = "chat/examview/:type/:type_nm/:class/:class_nm", layout = ChatLayout.class)
@PermitAll
@Uses(Icon.class)
@PreserveOnRefresh
public class ChatExamView extends SysWindow  implements WindowImpl,BeforeEnterObserver {
	...
	@Autowired
	public ChatExamView(AuthenticatedUser securityService,Iteach4uService jdbc) {
    ...
    public void wRetrieve() {
    	...
    	String str = "다음의 형식을 지켜서 \n" + " "+type_nm+" "+subject_nm +"과목에서 "+class_nm +"수준의 " +unit_nm +"에 관한문제 단 1 문제만 만들어줘" 
    			+ "\n"
    			+ "[문제]\n"
    			+ "<문제 내용>\n"
    			+ "\n"
