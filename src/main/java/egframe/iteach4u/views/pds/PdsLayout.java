...
@Route(value = "pdsmain")//, layout = MainLayout.class)
//@Layout
@PermitAll
public class PdsLayout extends AppLayout implements AfterNavigationObserver{
	...
	private SideNavItem pds01 = new SideNavItem("학습자료실");
	private SideNavItem pds02 = new SideNavItem("기출자료실");
...
//	@Autowired
	...
	@Autowired
	public PdsLayout(AuthenticatedUser securityService,Iteach4uService _jdbc) {
   	...
   	if(k>0) {
    	...
    	for (int i = 0 ;i < k ;i++) {
    		pds01.addItem(new SideNavItem(class_data.get(i).get_class_nm(),
    				//"pds/dataview/"+String.valueOf(class_data.get(i).get_type_id())+"/"+String.valueOf(class_data.get(i).getId()),VaadinIcon.DASHBOARD.create()));
    				"pds/dataview/"+String.valueOf(class_data.get(i).get_type_id())+"/"+String.valueOf(class_data.get(i).get_type_nm())+"/"+
    		...
    		pds02.addItem(new SideNavItem(class_data.get(i).get_class_nm(),
    				"pds/pastview/"+String.valueOf(class_data.get(i).get_type_id())+"/"+String.valueOf(class_data.get(i).get_type_nm())+"/"+
							String.valueOf(class_data.get(i).getId())+"/"+String.valueOf(class_data.get(i).get_class_nm())+"",
							VaadinIcon.DASHBOARD.create()));
