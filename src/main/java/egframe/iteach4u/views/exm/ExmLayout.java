...
@Route(value = "exmmain")//, layout = MainLayout.class)
//@Layout
@PermitAll
public class ExmLayout extends AppLayout implements AfterNavigationObserver{
	...
	private SideNavItem exm01 = new SideNavItem("문항관리");
	private SideNavItem exm02 = new SideNavItem("문제지관리");
	private SideNavItem exm03 = new SideNavItem("문제풀기");
...
//	@Autowired
	...
	@Autowired
	public ExmLayout(AuthenticatedUser securityService,Iteach4uService _jdbc) {
    ...
    private void setLeftMenu() {
       ...
       exm01.setPrefixComponent(VaadinIcon.FOLDER.create());
       exm01.setRouterIgnore(true);
       //pds01.setExpanded(true);
       
   		
       exm02.setPrefixComponent(VaadinIcon.FOLDER.create());
       exm02.setRouterIgnore(true);
       //pds02.setExpanded(true);
       
       exm03.setPrefixComponent(VaadinIcon.FOLDER.create());
       exm03.setRouterIgnore(true);
       //pds02.setExpanded(true);

       leftmenu.addItem(exm01,exm02,exm03);
    ...
    private void setSubMenu() {
   	...
   	if(k>0) {
    	...
    	for (int i = 0 ;i < k ;i++) {
    		exm01.addItem(
    				new SideNavItem(class_data.get(i).get_class_nm(),
    						"exm/unitview/"+String.valueOf(class_data.get(i).get_type_id())+"/"+String.valueOf(class_data.get(i).get_type_nm())+"/"+
								String.valueOf(class_data.get(i).getId())+"/"+String.valueOf(class_data.get(i).get_class_nm())+"",
								VaadinIcon.DASHBOARD.create())
    				);
    		exm02.addItem(
    				new SideNavItem(class_data.get(i).get_class_nm(),
    						"exm/makeview/"+String.valueOf(class_data.get(i).get_type_id())+"/"+String.valueOf(class_data.get(i).get_type_nm())+"/"+
							String.valueOf(class_data.get(i).getId())+"/"+String.valueOf(class_data.get(i).get_class_nm())+"",
							VaadinIcon.DASHBOARD.create())
    				);
    		exm03.addItem(
    				new SideNavItem(class_data.get(i).get_class_nm(),
    					"exm/passview/"+String.valueOf(class_data.get(i).get_type_id())+"/"+String.valueOf(class_data.get(i).get_type_nm())+"/"+
							String.valueOf(class_data.get(i).getId())+"/"+String.valueOf(class_data.get(i).get_class_nm())+"",
							VaadinIcon.DASHBOARD.create())
    				);
