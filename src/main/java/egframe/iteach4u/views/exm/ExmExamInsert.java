...
//@PageTitle("학습자료/입력 폼")
@Route(value = "exm/examviewinsert/:id", layout = ExmLayout.class)
@PermitAll
@Uses(Icon.class)
@PreserveOnRefresh
public class ExmExamInsert extends SysWindow  implements WindowImpl,AfterNavigationObserver,RouterLayout,BeforeEnterObserver{
    ...
    public ExmExamInsert(AuthenticatedUser securityService,Iteach4uService jdbc) {
