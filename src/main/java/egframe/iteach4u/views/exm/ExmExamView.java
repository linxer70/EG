...
@Route(value = "exm/examview/:type/:type_nm/:class/:class_nm", layout = ExmLayout.class)
@PermitAll
@Uses(Icon.class)
@PreserveOnRefresh
public class ExmExamView extends SysWindow  implements WindowImpl,BeforeEnterObserver {
	...
	@Autowired
	public ExmExamView(AuthenticatedUser securityService,Iteach4uService jdbc) {
