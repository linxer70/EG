...
public class d_pds_past_row extends SysGrid<pds_file_row> {//implements DataWindowImpl { 
	private BeanValidationBinder binder ;
	//private SysFreeForm freeform;
	Anchor downloadLink = null;
	private Iteach4uService Jdbc;
    public d_pds_past_row() {		
//    	super(pds_file_row.class);

 	} 
    public d_pds_past_row(@Autowired Iteach4uService dbo) {
//    	super(pds_file_row.class);
      	//setCon(dbo.getCon());
    	//setTransObject(dbo);
    	Jdbc = dbo;
