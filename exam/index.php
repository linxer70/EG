...
#회차별 문제풀기
if ($gubun == '1') {
	$sql = "SELECT d.num,e.unit_link FROM bsc_class b,bsc_type c,exm_list a,exm_list_row d,exm_unit e,hum_subject f
...
#회차별 틀린문제다시풀기
	...
	(
		...
		from
		mem_list_row a,exm_unit_anw b,exm_list_row c,exm_unit d,hum_subject e
		where
		...
		and c.type_cd = e.type_cd
		and c.class_cd = e.class_cd
...
#과목별 틀린문제 다시 풀기
	...
	$sql = "SELECT d.num,e.unit_link FROM bsc_class b,bsc_type c,exm_list a,exm_list_row_tmp d,exm_unit e,hum_subject f
	 where a.type_cd = b.type_cd and a.class_cd = b.class_cd and a.type_cd = c.type_cd and a.list_cd = d.list_cd
	 and a.type_cd = d.type_cd and a.class_cd = d.class_cd and a.exam_cd = d.exam_cd and d.unit_idx = e.mat_idx
	 and d.unit_cd = e.unit_cd  and d.type_cd = f.type_cd and d.class_cd = f.class_cd and d.subject_cd = f.subject_cd 
	 and f.close_yn <> 'Y'   and d.user_id = f.user_id and f.user_id = '"."$user_id"."'  and a.list_cd = '"."$list_cd"."'
	  and a.type_cd = '"."$type_cd"."' and a.class_cd = '"."$class_cd"."' 
	   and a.exam_cd ='"."$exam_cd"."' order by d.num limit ".$first.",".$num_per_page;
