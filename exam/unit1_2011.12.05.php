...
#과목별 틀린문제 다시 풀기
	...
	$sql = "SELECT d.num,e.unit_link 
		FROM exm_list_row_tmp d,exm_unit e
...
<table width="500" border="0" cellspacing="0" cellpadding="0" class="test_form">
  ...
  <tr> 
	<td width="24" background="../images/box_left.gif">&nbsp;</td>
	...
	<table width="452" border="0" cellspacing="0" cellpadding="0" class="test_form">
	  ...
	  <tr> 
		...
		<td width="418"  height="30" align="left" valign="top"> 
		<? include '..'.$row[unit_link];
		//include _DOCROOT.$row[unit_link]; ?></td>
	  </tr>
	  <tr> 
		<td height="10" colspan="3"></td>
	  </tr>
	...
	<td width="24" background="../images/box_right.gif"></td>
  </tr>
